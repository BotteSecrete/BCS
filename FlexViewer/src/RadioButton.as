package 
{
	...
	/**
	 * Extends the default RadioButton class to fix an annoying problem that happens when the 
	 * mouse moves in between the radiobutton and the label and the control loses focus and 
	 ...
	 */
	public class RadioButton extends mx.controls.RadioButton
	{
