...
private function sendMail(id:String, locaID:String, projID:Number):void
{
	...
	var _emailMessage:String = "BoreHole Completed for hole id" + id;//emailMessage.text;
	var _emailSubject:String = "["+getSharedObject.data.user.username+"] Borehole Completed in SYG"; //emailSubject.text;
	...
	{ 
		...
		MyEditWidget.index.simpleToaster.toast(toastMessage);
	}
	...
	function onProjQueryFault(fault:Fault, token:Object = null) : void
	{
