...
{
	onQueryCondResult(featureSet, condEditsStarted,condEditsCompleted);
}
...
{
	if(!cond.willTrigger(FaultEvent.FAULT))
	{
		cond.addEventListener(FaultEvent.FAULT, condEditsFault);
	}
	
	if(!cond.willTrigger(FeatureLayerEvent.EDITS_COMPLETE))
	{
