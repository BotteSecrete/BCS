...
private function saveInfoEditedKey(txtIn:Object, event:FeatureLayerEvent, k:Number):void
{
	...
	switch(txtIn.name)
	{
		...
		case "BW":
			saveTI(txtIn,attributes,"BW",event.features[k],3);
			break;
		
		case "BL":
			saveTI(txtIn,attributes,"BL",event.features[k],2);
			break;
		
		case "SAG":
			saveTI(txtIn,attributes,"NSL",event.features[k],42);
			break;
		...
		case "genUBInput":
			saveTI(txtIn,attributes,"UB_Descr",event.features[k]);
			break;
		
		case "genHBInput":
			saveTI(txtIn,attributes,"HB_Descr",event.features[k]);
			break;
...
private function saveInfoEdited(ev:FlexEvent, event:FeatureLayerEvent, k:Number):void
{
	...
	switch(ev.currentTarget.name)
	{
		...
		case "SAG":
			saveTI(ev.currentTarget,attributes,"NSL",event.features[k],42);
			break;
		...
		case "ADOB":
			saveTI(ev.currentTarget,attributes,"Depth_Storey",event.features[k],2)
			break;
