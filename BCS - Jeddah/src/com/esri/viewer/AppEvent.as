...
public class AppEvent extends Event
{
     ...
     */
	public static const ADD_GRAT_ROW:String = "addGratRow";
	public static const DEL_GRAT_ROW:String = "delGratRow";
	
	public static const MINIMIZE_VC:String = "minimizeVC";
	public static const MIN_PAN_MAP:String = "minPanMap";
	public static const COLLAPSE_PANEL_RESIZE:String = "collapsePanelResize";
	public static const COLLAPSE_PANEL_OPENED_END:String = "collapsePanelOpenedEnd";

	
	public static const RELATED_CALLED:String = "relatedTableCalled";
	
	public static const MINIMZE_INFOWINDOW :String = "minimizeInfoWindow";
	
	public static const LANUGUAGE_CHANGED:String = "languageChanged";
	
	public static const BOTTOM_PANEL_CLOSED:String = "bottomPanelClosed";
	public static const BOTTOM_PANEL_OPENED:String = "bottomPanelOpened";
