...
//				hasToSave = true;
//				Alert.show("ObjectID : "+condArray[0],"Debugg");
//			}
//			break;
//	}
...
private function saveInfoCondEditedKey(txtIn:Object, event:FeatureLayerEvent, k:Number):void
{
	var attributes:Object = {};
	attributes = isInCond? {OBJECTID:condArray[0]} : {IDBATI:event.features[k].attributes.OBJECTID};
	
	saveTICond(txtIn,attributes,"Other_Damage_Descr", event.features[k]);
}
