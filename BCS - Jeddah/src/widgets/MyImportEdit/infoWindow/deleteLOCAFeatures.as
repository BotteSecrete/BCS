...
private function deleteFeature(event:FeatureLayerEvent, k:Number):void
{
	...
	Alert.show("Are you sure you want to delete  this borehole","Make your choice",mx.controls.Alert.YES | mx.controls.Alert.NO,null, alertListener, null, mx.controls.Alert.YES)
